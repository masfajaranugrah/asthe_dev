            ...
            <div className="col-12 col-lg-7 col-xl-5">
              <div className="text-center text-lg-start">
                <p className="primary-text">
                  We are a digital design and development agency based in Indonesia that focuses on creating websites, mobile applications, and AI solutions to help businesses grow through technological innovation.
                </p>
              </div>
            </div>
          </div>
